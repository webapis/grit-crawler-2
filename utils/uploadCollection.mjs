...
import mergePrevData from '../utils/mergeNewData.mjs'
...
async function uploadCollection({ fileName, data, gender, marka }) {
    ...
    const responsesha = await fetch(`https://api.github.com/repos/webapis/crawle-state-2/contents/${gender}/${fileName}.json.gz`, { method: 'get', headers: { Accept: "application/vnd.github.v3+json", authorization: `token ${process.env.GH_TOKEN}`, "X-GitHub-Api-Version": "2022-11-28" } })
debugger
...
async function getZipFiles(gender) {
    ...
    const response = await fetch(`https://api.github.com/repos/webapis/crawle-state-2/branches`, { method: 'get', headers: { Accept: "application/vnd.github.raw", authorization: `token ${process.env.GH_TOKEN}`, "X-GitHub-Api-Version": "2022-11-28" } })
    ...
    const treeResponse = await fetch(`https://api.github.com/repos/webapis/crawle-state-2/git/trees/${sha}?recursive=1`, { method: 'get', headers: { Accept: "application/vnd.github.raw", authorization: `token ${process.env.GH_TOKEN}`, "X-GitHub-Api-Version": "2022-11-28" } })
...
async function getContent(filepath) {
    ...
    const response = await fetch(`https://api.github.com/repos/webapis/crawle-state-2/contents/${filepath}`, { method: 'get', headers: { Accept: "application/vnd.github.raw", authorization: `token ${process.env.GH_TOKEN}`, "X-GitHub-Api-Version": "2022-11-28" } })
